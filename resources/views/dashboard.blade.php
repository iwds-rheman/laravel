...
<body>
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div>
                                            <div class="feed-activity-list">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="dashboard/img/a2.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="dashboard/img/a3.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
                                                ...
                                                <div class="feed-element">
                                                    <a href="profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="dashboard/img/a5.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
    ...
    <!-- GITTER -->
    <script src="dashboard/js/plugins/gritter/jquery.gritter.min.js"></script>
